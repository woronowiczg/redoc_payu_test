...
* Security schemes: you will define the scheme(s) your API uses for security (e.g. OAuth2, API Key, etc...). The security schemes are used by the Redocly API Reference "Try It" API console feature.
